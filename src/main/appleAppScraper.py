...
class Scraper:
    def scrapApp(self,app_link):#scrap the app page
        ...
        #App Title
        help = Helper()
        app_title = unidecode.unidecode(help.textCleaner(app_title_age.replace(app_age,"")))
        ...
        if  objectChecker(app_price)=="Gratis":
          app_price = 0
        else:
        ...
        #App Developer
        app_entwickler = help.textCleaner(objectChecker(app_entwickler1))
        #developer Id
...
class Helper:   
  # a function to remove the spaces from a text     
